...
function SliderCard({data}) {
  return (
    <div className="slider-student-card">
    <div className="slider-student-card-top">
    <img className='slider-student-bg' src={data?.inst_image?.image_full_url} alt="" />
   <div className='ttttt'>
    ...
    <div className="slider-student-card-bottom">
